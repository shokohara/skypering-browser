...
.controller("ProfileController",
  ["$scope", "$log", "Constant", "Status", "Session", "$browser", "Users",
    ($scope, $log, Constant, Status, Session, $browser, Users) ->
